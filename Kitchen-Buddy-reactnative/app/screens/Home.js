...
import banner from "../../assets/images/groceryBanner_small.jpg"
...
function Home(props) {
    ...
    return (
        <View style={styles.container}>
            ...
            <ImageBackground style={{ width: windowWidth, height: RFPercentage(30), flex: 0.8, flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end' }} source={banner} >
                <View style={{ flexDirection: 'column' }} >
                    {/* Text feilds */}
                    <View style={{ width: "85%", bottom: RFPercentage(9) }} >
                        <AppTextInput
                            placeHolder="Search"
                            width="100%"
                            value={searchValue}
